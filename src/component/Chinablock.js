...
function Chinablock(props) {
    let [post, setPost] = useState([])
  useEffect(() => {
    axios.get(`https://newsapi.org/v2/top-headlines?country=cn&category=${props.slug}&apiKey=148036c85b5b416ab6b7d8e2820c6194`)
      .then(res => {
