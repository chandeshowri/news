...
export default function Main() {
  ...
  useEffect(() => {
    axios.get('https://newsapi.org/v2/top-headlines?category=general&apiKey=148036c85b5b416ab6b7d8e2820c6194')
      .then(res => {
      ...
      <div className='row'>
        {post.slice(0, 1).map((a) => (
          <div className='col-lg-8 py-2 '>
            ...
            <h3 className='py-3'><Link to={`/Detail/${a.id}`}>{a.title}</Link></h3>
